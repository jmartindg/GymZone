      ...
      <section className="container mx-auto min-h-screen flex items-center flex-col md:flex-row py-28 px-4 lg:px-0">
        ...
        <section className="flex-1 w-full mt-14 md:mt-0">
          ...
          <details className="mb-2">
            ...
            <div className="content bg-white p-4">
              <p className="font-medium">
                The gym opens at 8:00 A.M to 8:00 P.M, Monday to Saturday. The gym is closed at Sundays and closed
                during holidays.
              </p>
            </div>
          </details>
          ...
          <details className="mb-2">
            ...
            <div className="content bg-white p-4">
              <p className="font-medium">
                Yes, you can cancel the membership. However you will not be able to refund the fees that you paid to
                become a member.
              </p>
            </div>
          </details>
